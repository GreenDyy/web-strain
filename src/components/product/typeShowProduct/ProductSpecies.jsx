...
function ProductSpecies() {
    const { nameSpecies, pageRouter } = useParams();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const dataStrain = await getAllStrainFollowPhylumApi(nameSpecies, search, sortBy, pageRouter)
        ...
        fetchData()
    }, [search, sortBy, pageRouter, nameSpecies])
                ...
                <div className='col-all-item'>
                    ...
                    <ReactPaginate
                        ...
                        onPageChange={(event) => {
                            ...
                            navigate(`/Product/Species/${nameSpecies}/${selectedPage + 1}`);
