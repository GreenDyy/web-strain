...
import { getAllPhylumApi, getAllStrainFollowGenusApi } from '../../../apis/apiStrain'
...
function ProductGenus() {
    const { nameGenus, pageRouter } = useParams();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const dataStrain = await getAllStrainFollowGenusApi(nameGenus, search, sortBy, pageRouter)
        ...
        fetchData()
    }, [search, sortBy, pageRouter, nameGenus])
                ...
                <div className='col-all-item'>
                    ...
                    <ReactPaginate
                        ...
                        onPageChange={(event) => {
                            ...
                            navigate(`/Product/Genus/${nameGenus}/${selectedPage + 1}`);
