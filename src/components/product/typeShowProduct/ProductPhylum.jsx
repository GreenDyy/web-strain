...
function ProductPhylum() {
    const { namePhylum, pageRouter } = useParams();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const dataStrain = await getAllStrainFollowPhylumApi(namePhylum, search, sortBy, pageRouter)
                setTreeData(dataTree.data);
                setDataStrain(dataStrain.data);
                setTotalPage(dataStrain.data[0]?.totalPage)
                console.log('phylumStrainAPI:', dataStrain.data)
            }
            catch (error) {
        ...
        fetchData()
    }, [search, sortBy, pageRouter, namePhylum])
                ...
                <div className='col-all-item'>
                    ...
                    <ReactPaginate
                        ...
                        onPageChange={(event) => {
                            ...
                            navigate(`/Product/Phylum/${namePhylum}/${selectedPage + 1}`);
